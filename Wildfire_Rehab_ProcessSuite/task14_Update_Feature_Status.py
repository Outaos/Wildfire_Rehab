...
def update_status(fc, new_status):
    ...
    if not fidset:
        msg = "Step 14. No features are selected. Please select one or more features before running the tool."
    ...
    arcpy.AddMessage(f"Step 14.  All selected features updated to Status = '{new_status}'.")
